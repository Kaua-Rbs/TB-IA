...
export const copy = {
  pt: {
    ...
    territorial: {
      ...
      resistance: {
        title: "Vigilância da resistência",
        publicSignals: "Sinais públicos",
        confirmedStatus: "Carga confirmada",
        rankingEffect: "Efeito no ranking",
        reviewStatus: "Validação de domínio",
        signalValue: "Valor observado",
        signalBasis: "Base",
        signalThreshold: "Referência comparativa",
        source: "Fonte e referência",
        noSource: "Proveniência não informada",
      },
      caveats: "Ressalvas",
      history: {
    ...
    operations: {
      ...
      signal: "Sinal",
      signalKind: "Natureza do sinal",
      signalKinds: "Sinais associados",
      team: "Equipe",
      facility: "Unidade",
      type: "Tipo",
      evidenceReview: "Revisão da evidência",
      structuredEvidence: "Evidências estruturadas",
      evidenceStatus: "Situação da evidência",
      observedAt: "Data observada",
      resistanceScope: "Escopo da resistência",
      evidenceSources: "Fontes",
      noEvidence: "Nenhuma evidência estruturada associada.",
    },
    statuses: {
      ready: "pronto",
      partial: "parcial",
    ...
    resistanceSignals: {
      ...
      resistance_risk_history: "Histórico associado a risco",
  ...
  en: {
    ...
    territorial: {
      ...
      resistance: {
        ...
        confirmedStatus: "Confirmed burden",
        rankingEffect: "Ranking effect",
        reviewStatus: "Domain validation",
        signalValue: "Observed value",
        signalBasis: "Basis",
        signalThreshold: "Comparative reference",
        source: "Source and reference",
        noSource: "Provenance not provided",
      },
      caveats: "Caveats",
      history: {
    ...
    operations: {
      ...
      signalKinds: "Associated signals",
      team: "Team",
      facility: "Facility",
      type: "Type",
      ...
      resistanceScope: "Resistance scope",
      evidenceSources: "Sources",
      noEvidence: "No structured evidence is associated.",
    },
    statuses: {
      ready: "ready",
      partial: "partial",
    ...
    resistanceSignals: {
      ...
      resistance_risk_history: "Risk-associated history",
