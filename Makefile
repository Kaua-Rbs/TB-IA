PYTHON ?= python3
MARKDOWN_FILES = AGENTS.md CONTRIBUTING.md README.md descricao_do_projeto.md frentes_de_desenvolvimento.md guia_validacao_de_dominio.md mvp2_municipal_contracts.md proximos_passos.md referencias.md especificacao_tecnica_do_sistema.md
